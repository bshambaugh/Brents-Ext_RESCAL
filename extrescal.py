...
from loadXfromTTL import loadXfromTTL
...
X = loadXfromTTL('oldfood.ttl')

# I do not know how to create the entity-term matrix from scratch...    
# I need to create a new loadDfromTTL file???
D = loadDfromTTL('oldfood.ttl')
print D
#D = loadD(inputDir, dim)         
...
print 'no A is:'
print A
print 'the dimensions of A are:'
print A.shape
savetxt(outputEntities, A)
V = result[5]
print 'now V is:'
print V
print 'the dimensions of V are:'
print V.shape
